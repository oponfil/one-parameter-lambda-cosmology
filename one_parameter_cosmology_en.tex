...
As a \emph{hypothetical} illustration we note that in measurements of anomalous quantum noise in YBCO-based Josephson junctions~\cite{Hoffmann2004} a roll-off of the noise spectral density was observed at $\nu \approx 0.6$--$0.8$~THz; the corresponding \emph{reduced} wavelength $\bar\lambda = c/(2\pi\nu) \approx 60$--$80~\mu$m turns out to be close to $\bar\lambda_\Lambda \approx 52~\mu$m ($\nu \approx 0.92$~THz), whereas $\ell_{\mathrm{PE}} \approx 37~\mu$m would correspond to an overestimated frequency $\approx 1.3$~THz. We emphasize that the interpretation of this roll-off as a manifestation of vacuum fluctuations remains controversial and has not received independent confirmation, so we regard this coincidence only as a guide and not as observational proof of the model.
...
The idea of expressing the CMB temperature through the geometric mean of the Hawking and Planck temperatures is close to the recent approaches of Haug and Tatum~\cite{Haug2023}, who relate the temperature scales of the cosmological and Planck horizons. However, in our work this relation is derived from the Friedmann equations and the holographic condition at the density-equality epoch $\tau_{m\Lambda}$.
